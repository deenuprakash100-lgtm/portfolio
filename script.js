...
function openProjectModal(projectId) {
  ...
  const screenshotHtml = project.image
    ? `<img src="${project.image}" alt="${project.title} screenshot" class="modal-content__shot-img" loading="lazy">`
    : `<div class="modal-content__shot"><i class="fa-solid fa-image"></i>&nbsp; Screenshot placeholder — add project screenshots to assets/screenshots/</div>`;
  ...
  body.innerHTML = `
    ...
    <div class="modal-content__actions">
      <a href="https://github.com/deenuprakash100-lgtm" target="_blank" rel="noopener noreferrer" class="btn btn--ghost btn--sm">
...
function initContactForm() {
  ...
  form.addEventListener('submit', (e) => {
    ...
    const mailtoLink = `mailto:deenuprakash100@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(mailBody)}`;
